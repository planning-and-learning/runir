...
#include <runir/kr/dl/grammar/constructor_view.hpp>
...
{
    using Entity = kr::dl::grammar::Constructor<Family, Category>;
    using View = ygg::View<ygg::Index<Entity>, kr::dl::grammar::ConstructorRepositoryFor<Family>>;
    static_assert(std::same_as<View, kr::dl::grammar::FamilyConstructorView<Family, Category>>);
    if constexpr (std::same_as<Family, kr::BaseFamilyTag>)
        return std::same_as<View, kr::dl::grammar::BaseConstructorView<Category>>;
    else
        return true;
}
...
static_assert(indexed_data_views<kr::BaseFamilyTag>(kr::dl::grammar::FamilyConstructorTypes<kr::BaseFamilyTag> {}));
static_assert(indexed_data_views<kr::ExtFamilyTag>(kr::dl::grammar::FamilyConstructorTypes<kr::ExtFamilyTag> {}));
static_assert(indexed_data_views<kr::UnsFamilyTag>(kr::dl::grammar::FamilyConstructorTypes<kr::UnsFamilyTag> {}));
