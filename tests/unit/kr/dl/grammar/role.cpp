...
#include <runir/kr/dl/grammar/role_index.hpp>
...
static_assert(indexed_data_views<kr::BaseFamilyTag>(kr::dl::grammar::FamilyRoleTypes<kr::BaseFamilyTag> {}));
static_assert(indexed_data_views<kr::ExtFamilyTag>(kr::dl::grammar::FamilyRoleTypes<kr::ExtFamilyTag> {}));
static_assert(indexed_data_views<kr::UnsFamilyTag>(kr::dl::grammar::FamilyRoleTypes<kr::UnsFamilyTag> {}));
...
{
    using Entity = kr::dl::grammar::Role<Family, Tag>;
    using Data = ygg::Data<Entity>;
    using View = ygg::View<ygg::Index<Entity>, kr::dl::grammar::ConstructorRepositoryFor<Family>>;

    static_assert(std::same_as<View, kr::dl::grammar::FamilyRoleView<Family, Tag>>);
    if constexpr (std::same_as<Family, kr::BaseFamilyTag>)
        static_assert(std::same_as<View, kr::dl::grammar::BaseRoleView<Tag>>);
