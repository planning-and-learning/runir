...
Positive atomic state concept & \texttt{(c\_atomic\_state "p" true)} & $P$ \\
Negative atomic state concept & \texttt{(c\_atomic\_state "p" false)} & $\neg P$ \\
...
Positive atomic state role & \texttt{(r\_atomic\_state "p" true)} & $P$ \\
Negative atomic state role & \texttt{(r\_atomic\_state "p" false)} & $\neg P$ \\
