...
struct GenerateResults
{
    ...
    std::vector<runir::ConstructorView<runir::ConceptTag>> concepts;
    std::vector<runir::ConstructorView<runir::RoleTag>> roles;
    std::vector<runir::ConstructorView<runir::BooleanTag>> booleans;
    std::vector<runir::ConstructorView<runir::NumericalTag>> numericals;
