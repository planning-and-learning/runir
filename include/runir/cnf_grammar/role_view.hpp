...
#include "runir/cnf_grammar/role_data.hpp"
...
class View<Index<runir::cnf_grammar::Role<Tag>>, C>
{
private:
    const C* m_context;
    Index<runir::cnf_grammar::Role<Tag>> m_handle;

public:
    View(Index<runir::cnf_grammar::Role<Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
