...
#include "runir/cnf_grammar/boolean_data.hpp"
...
class View<Index<runir::cnf_grammar::Boolean<Tag>>, C>
{
private:
    const C* m_context;
    Index<runir::cnf_grammar::Boolean<Tag>> m_handle;

public:
    View(Index<runir::cnf_grammar::Boolean<Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
