...
#include "runir/cnf_grammar/constructor_view.hpp"
#include "runir/cnf_grammar/derivation_rule_data.hpp"
...
class View<Index<runir::cnf_grammar::DerivationRule<Category>>, C>
{
private:
    const C* m_context;
    Index<runir::cnf_grammar::DerivationRule<Category>> m_handle;

public:
    View(Index<runir::cnf_grammar::DerivationRule<Category>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
