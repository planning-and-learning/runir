...
template<>
struct Builder<runir::semantics::Denotation<runir::BooleanTag>>
{
...
template<>
struct Builder<runir::semantics::Denotation<runir::NumericalTag>>
{
...
template<>
struct Builder<runir::semantics::Denotation<runir::ConceptTag>>
{
...
template<>
struct Builder<runir::semantics::Denotation<runir::RoleTag>>
{
    using Block = runir::uint_t;
    using Blocks = std::vector<Block>;
    using Bitset = tyr::BitsetSpan<Block>;
