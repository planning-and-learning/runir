...
struct Index<runir::semantics::Denotation<Category>> : IndexMixin<Index<runir::semantics::Denotation<Category>>>
{
    using Base = IndexMixin<Index<runir::semantics::Denotation<Category>>>;
    using Base::Base;
};
