...
struct Data<runir::kr::ps::ConcreteConditionVariant<runir::kr::BaseFamilyTag, runir::kr::DlTag>>
{
    using Variant = ::cista::offset::variant<
        Index<runir::kr::ps::
                  ConcreteCondition<runir::kr::BaseFamilyTag, runir::kr::DlTag, runir::kr::ps::base::dl::BooleanFeature, runir::kr::ps::base::dl::Positive>>,
        Index<runir::kr::ps::
                  ConcreteCondition<runir::kr::BaseFamilyTag, runir::kr::DlTag, runir::kr::ps::base::dl::BooleanFeature, runir::kr::ps::base::dl::Negative>>,
        Index<runir::kr::ps::
                  ConcreteCondition<runir::kr::BaseFamilyTag, runir::kr::DlTag, runir::kr::ps::base::dl::NumericalFeature, runir::kr::ps::base::dl::EqualZero>>,
        Index<runir::kr::ps::ConcreteCondition<runir::kr::BaseFamilyTag,
                                               runir::kr::DlTag,
                                               runir::kr::ps::base::dl::NumericalFeature,
                                               runir::kr::ps::base::dl::GreaterZero>>>;
