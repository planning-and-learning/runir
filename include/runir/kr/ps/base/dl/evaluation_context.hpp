...
{
private:
    runir::kr::dl::semantics::EvaluationContext<runir::kr::BaseFamilyTag, Kind> m_source_context;
    runir::kr::dl::semantics::EvaluationContext<runir::kr::BaseFamilyTag, Kind> m_target_context;
