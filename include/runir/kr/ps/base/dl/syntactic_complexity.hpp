...
void insert_unique(std::vector<ygg::Index<runir::kr::ps::Feature<runir::kr::BaseFamilyTag, FeatureTag>>>& features,
...
void collect_feature(FeatureSyntacticComplexityContext& context, ygg::View<ygg::Index<runir::kr::ps::Feature<runir::kr::BaseFamilyTag, FeatureTag>>, C> feature)
{
...
void collect_features(FeatureSyntacticComplexityContext& context,
                      ygg::View<ygg::Index<runir::kr::ps::ConcreteConditionVariant<runir::kr::BaseFamilyTag, runir::kr::DlTag>>, C> condition)
{
...
template<typename C>
void collect_features(FeatureSyntacticComplexityContext& context, ygg::View<ygg::Index<runir::kr::ps::ConditionVariant<runir::kr::BaseFamilyTag>>, C> condition)
{
    ygg::visit([&](auto concrete_condition) { collect_features(context, concrete_condition); }, condition.get_variant());
}

template<typename C>
void collect_features(FeatureSyntacticComplexityContext& context, ygg::View<ygg::Index<runir::kr::ps::EffectVariant<runir::kr::BaseFamilyTag>>, C> effect)
{
    ygg::visit([&](auto concrete_effect) { collect_features(context, concrete_effect); }, effect.get_variant());
}

template<typename C>
void collect_features(FeatureSyntacticComplexityContext& context, ygg::View<ygg::Index<runir::kr::ps::base::Rule>, C> rule)
{
...
template<typename C>
void collect_features(FeatureSyntacticComplexityContext& context, ygg::View<ygg::Index<runir::kr::ps::base::Sketch>, C> sketch)
{
...
std::size_t syntactic_complexity(const FeatureSyntacticComplexityContext& features, const C& context)
{
    ...
    {
        const auto view = ygg::View<ygg::Index<runir::kr::ps::Feature<runir::kr::BaseFamilyTag, runir::kr::ps::dl::BooleanFeature>>, C>(feature, context);
    ...
    {
        const auto view = ygg::View<ygg::Index<runir::kr::ps::Feature<runir::kr::BaseFamilyTag, runir::kr::ps::dl::NumericalFeature>>, C>(feature, context);
        result += ygg::visit([](auto concrete_feature) { return syntactic_complexity(concrete_feature); }, view.get_variant());
    }
    return result;
}
