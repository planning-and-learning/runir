#ifndef RUNIR_KR_PS_UNS_SKETCH_EXECUTOR_IMPL_HPP_
#define RUNIR_KR_PS_UNS_SKETCH_EXECUTOR_IMPL_HPP_
...
public:
    ...
    auto find_compatible_rule(const tyr::planning::StateView<Kind>& seed_state, const tyr::planning::StateView<Kind>& state) -> std::optional<RuleView>
    {
        ...
        auto context = runir::kr::ps::dl::EvaluationContext<runir::kr::UnsFamilyTag, Kind>(seed_state, state, m_dl_builder, m_dl_denotation_repository);
