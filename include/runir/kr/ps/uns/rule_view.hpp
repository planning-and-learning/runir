#ifndef RUNIR_KR_PS_UNS_RULE_VIEW_HPP_
#define RUNIR_KR_PS_UNS_RULE_VIEW_HPP_
...
template<typename C>
class View<Index<runir::kr::ps::uns::Rule>, C>
{
private:
    const C* m_context;
    Index<runir::kr::ps::uns::Rule> m_handle;

public:
    View(Index<runir::kr::ps::uns::Rule> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
