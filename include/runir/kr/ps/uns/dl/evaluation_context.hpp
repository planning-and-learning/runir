#ifndef RUNIR_KR_PS_UNS_DL_EVALUATION_CONTEXT_HPP_
#define RUNIR_KR_PS_UNS_DL_EVALUATION_CONTEXT_HPP_
...
class EvaluationContext<runir::kr::UnsFamilyTag, Kind> :
    public BaseEvaluationContext<EvaluationContext<runir::kr::UnsFamilyTag, Kind>, runir::kr::UnsFamilyTag, Kind>
{
private:
    using Base = BaseEvaluationContext<EvaluationContext<runir::kr::UnsFamilyTag, Kind>, runir::kr::UnsFamilyTag, Kind>;
