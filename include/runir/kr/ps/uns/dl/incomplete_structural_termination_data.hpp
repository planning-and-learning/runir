#ifndef RUNIR_KR_PS_UNS_DL_INCOMPLETE_STRUCTURAL_TERMINATION_DATA_HPP_
#define RUNIR_KR_PS_UNS_DL_INCOMPLETE_STRUCTURAL_TERMINATION_DATA_HPP_
...
using NumericalFeatureView = ygg::View<ygg::Index<runir::kr::ps::Feature<runir::kr::UnsFamilyTag, runir::kr::ps::dl::NumericalFeature>>, Repository>;
