#ifndef RUNIR_KR_PS_UNS_DL_FORMATTER_HPP_
#define RUNIR_KR_PS_UNS_DL_FORMATTER_HPP_
...
#include "runir/kr/ps/uns/dl/incomplete_structural_termination_data.hpp"
...
namespace runir::kr::ps::uns::dl::format
{
...
void append_feature(std::ostream& os, ygg::View<ygg::Index<runir::kr::ps::ConcreteFeature<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag>>, C> view)
{
...
template<typename FeatureTag, typename C>
std::string feature(ygg::View<ygg::Index<runir::kr::ps::ConcreteFeature<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag>>, C> view, std::string_view)
{
    auto os = std::ostringstream {};
...
std::string condition(ygg::View<ygg::Index<runir::kr::ps::ConcreteCondition<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag, ObservationTag>>, C>,
...
template<typename FeatureTag, typename ObservationTag, typename C>
std::string effect(ygg::View<ygg::Index<runir::kr::ps::ConcreteEffect<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag, ObservationTag>>, C>,
                   std::string_view feature_name)
{
    auto os = std::ostringstream {};
    os << "(:" << ObservationTag::keyword << " " << feature_name << ")";
...
template<typename FeatureTag, typename C>
std::string feature(ygg::View<ygg::Index<runir::kr::ps::ConcreteFeature<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag>>, C> view)
{
...
template<typename FeatureTag, typename C>
struct fmt::formatter<ygg::View<ygg::Index<runir::kr::ps::ConcreteFeature<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag>>, C>> :
    fmt::formatter<std::string_view>
{
    using View = ygg::View<ygg::Index<runir::kr::ps::ConcreteFeature<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag>>, C>;
    auto format(View view, format_context& ctx) const { return fmt::formatter<std::string_view>::format(runir::kr::ps::uns::dl::format::feature(view), ctx); }
};

template<typename FeatureTag, typename ObservationTag, typename C>
struct fmt::formatter<ygg::View<ygg::Index<runir::kr::ps::ConcreteCondition<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag, ObservationTag>>, C>> :
    fmt::formatter<std::string_view>
{
    using View = ygg::View<ygg::Index<runir::kr::ps::ConcreteCondition<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag, ObservationTag>>, C>;
    auto format(View view, format_context& ctx) const
    {
        const auto text = runir::kr::ps::uns::dl::format::condition(view, fmt::format("f_{}", view.get_feature().get_index().get_value()));
        return fmt::formatter<std::string_view>::format(text, ctx);
    }
};

template<typename FeatureTag, typename ObservationTag, typename C>
struct fmt::formatter<ygg::View<ygg::Index<runir::kr::ps::ConcreteEffect<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag, ObservationTag>>, C>> :
    fmt::formatter<std::string_view>
{
    using View = ygg::View<ygg::Index<runir::kr::ps::ConcreteEffect<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag, ObservationTag>>, C>;
    auto format(View view, format_context& ctx) const
    {
        const auto text = runir::kr::ps::uns::dl::format::effect(view, fmt::format("f_{}", view.get_feature().get_index().get_value()));
        return fmt::formatter<std::string_view>::format(text, ctx);
    }
};

template<>
struct fmt::formatter<runir::kr::ps::uns::dl::PolicyGraphVertexLabel, char> : fmt::formatter<std::string_view>
{
    template<typename FormatContext>
    auto format(const runir::kr::ps::uns::dl::PolicyGraphVertexLabel& label, FormatContext& ctx) const
    {
...
template<>
struct fmt::formatter<runir::kr::ps::uns::dl::PolicyGraphEdgeLabel, char> : fmt::formatter<std::string_view>
{
    template<typename FormatContext>
    auto format(const runir::kr::ps::uns::dl::PolicyGraphEdgeLabel& label, FormatContext& ctx) const
    {
...
template<>
struct fmt::formatter<runir::kr::ps::uns::dl::StructuralTerminationResult, char> : fmt::formatter<std::string_view>
{
    template<typename FormatContext>
    auto format(const runir::kr::ps::uns::dl::StructuralTerminationResult& result, FormatContext& ctx) const
    {
...
template<>
struct fmt::formatter<runir::kr::ps::uns::dl::IncompleteStructuralTerminationResult, char> : fmt::formatter<std::string_view>
{
    template<typename FormatContext>
    auto format(const runir::kr::ps::uns::dl::IncompleteStructuralTerminationResult& result, FormatContext& ctx) const
    {
