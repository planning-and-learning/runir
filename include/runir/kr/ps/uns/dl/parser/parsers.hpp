#ifndef RUNIR_KR_PS_UNS_DL_PARSER_PARSERS_HPP_
#define RUNIR_KR_PS_UNS_DL_PARSER_PARSERS_HPP_
...
using base_boolean_feature_type = x3::rule<BooleanFeatureClass, ast::BooleanFeature<runir::kr::UnsFamilyTag>>;
using base_numerical_feature_type = x3::rule<NumericalFeatureClass, ast::NumericalFeature<runir::kr::UnsFamilyTag>>;
using base_feature_type = x3::rule<FeatureClass, ast::Feature<runir::kr::UnsFamilyTag>>;
...
using base_condition_observation_type = x3::rule<ConditionObservationClass, ast::ConditionObservation<runir::kr::UnsFamilyTag>>;
using base_condition_type = x3::rule<ConditionClass, ast::Condition<runir::kr::UnsFamilyTag>>;
...
using base_effect_observation_type = x3::rule<EffectObservationClass, ast::EffectObservation<runir::kr::UnsFamilyTag>>;
using base_effect_type = x3::rule<EffectClass, ast::Effect<runir::kr::UnsFamilyTag>>;

using base_rule_type = x3::rule<RuleClass, ast::Rule<runir::kr::UnsFamilyTag>>;
using base_sketch_type = x3::rule<SketchClass, ast::Sketch<runir::kr::UnsFamilyTag>>;
using base_sketch_root_type = x3::rule<SketchRootClass, ast::Sketch<runir::kr::UnsFamilyTag>>;
