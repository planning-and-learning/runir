...
template<typename C>
class View<Index<runir::kr::ps::Rule>, C>
{
private:
    const C* m_context;
    Index<runir::kr::ps::Rule> m_handle;

public:
    View(Index<runir::kr::ps::Rule> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
