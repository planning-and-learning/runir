...
public:
                 ...
                 || std::same_as<Kind, runir::kr::ps::ext::LoadTag<runir::kr::dl::RoleTag>>)
    {
        if constexpr (std::same_as<Kind, runir::kr::ps::ext::LoadTag<runir::kr::dl::ConceptTag>>)
            return View<Index<runir::kr::ps::ext::Register<runir::kr::dl::ConceptTag>>, C>(get_data().reg, *m_context);
        else
            return View<Index<runir::kr::ps::ext::Register<runir::kr::dl::RoleTag>>, C>(get_data().reg, *m_context);
    }
