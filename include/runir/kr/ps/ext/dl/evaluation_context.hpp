...
{
private:
    runir::kr::dl::semantics::EvaluationContext<runir::kr::ExtFamilyTag, Kind> m_source_context;
    runir::kr::dl::semantics::EvaluationContext<runir::kr::ExtFamilyTag, Kind> m_target_context;
