#ifndef RUNIR_KR_MPG_DL_FEATURE_DATA_HPP_
#define RUNIR_KR_MPG_DL_FEATURE_DATA_HPP_
...
template<>
struct Data<runir::kr::mpg::ConcreteFeature<runir::kr::DlTag, runir::kr::mpg::dl::ConceptFeature>>
{
    Index<runir::kr::mpg::ConcreteFeature<runir::kr::DlTag, runir::kr::mpg::dl::ConceptFeature>> index;
    Index<runir::kr::mpg::dl::Constructor<runir::kr::dl::ConceptTag>> feature;
    ::cista::offset::string symbol;
    ::cista::offset::string description;

    Data() = default;
    Data(Index<runir::kr::mpg::dl::Constructor<runir::kr::dl::ConceptTag>> feature_, ::cista::offset::string symbol_, ::cista::offset::string description_) :
        index(),
        feature(feature_),
    ...
    Data(Index<runir::kr::mpg::dl::Constructor<runir::kr::dl::ConceptTag>> feature_, const std::string& symbol_, const std::string& description_) :
        index(),
        feature(feature_),
        symbol(symbol_),
...
template<>
struct Data<runir::kr::mpg::ConcreteFeature<runir::kr::DlTag, runir::kr::mpg::dl::BooleanFeature>>
{
    Index<runir::kr::mpg::ConcreteFeature<runir::kr::DlTag, runir::kr::mpg::dl::BooleanFeature>> index;
...
template<>
struct Data<runir::kr::mpg::ConcreteFeature<runir::kr::DlTag, runir::kr::mpg::dl::NumericalFeature>>
{
    Index<runir::kr::mpg::ConcreteFeature<runir::kr::DlTag, runir::kr::mpg::dl::NumericalFeature>> index;
