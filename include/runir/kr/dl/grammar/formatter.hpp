...
std::string rule(ygg::View<ygg::Index<DerivationRule<Family, Category>>, C> view)
{
    ...
    {
        rhs.push_back(ygg::visit(
            [](auto arg)
            {
                if constexpr (std::same_as<std::decay_t<decltype(arg)>, ygg::View<ygg::Index<Constructor<Family, Category>>, C>>)
...
template<runir::kr::dl::FamilyTag Family, typename Tag, typename C>
    requires runir::kr::dl::FamilyRoleConstructorTag<Family, Tag>
struct fmt::formatter<ygg::View<ygg::Index<runir::kr::dl::grammar::Role<Family, Tag>>, C>> : fmt::formatter<std::string_view>
{
...
template<runir::kr::dl::FamilyTag Family, typename Tag, typename C>
    requires runir::kr::dl::FamilyBooleanConstructorTag<Family, Tag>
struct fmt::formatter<ygg::View<ygg::Index<runir::kr::dl::grammar::Boolean<Family, Tag>>, C>> : fmt::formatter<std::string_view>
{
...
template<runir::kr::dl::FamilyTag Family, typename Tag, typename C>
    requires runir::kr::dl::FamilyNumericalConstructorTag<Family, Tag>
struct fmt::formatter<ygg::View<ygg::Index<runir::kr::dl::grammar::Numerical<Family, Tag>>, C>> : fmt::formatter<std::string_view>
{
...
template<runir::kr::dl::FamilyTag Family, runir::kr::dl::CategoryTag Category, typename C>
struct fmt::formatter<ygg::View<ygg::Index<runir::kr::dl::grammar::Constructor<Family, Category>>, C>> : fmt::formatter<std::string_view>
{
...
template<runir::kr::dl::FamilyTag Family, runir::kr::dl::CategoryTag Category, typename C>
struct fmt::formatter<ygg::View<ygg::Index<runir::kr::dl::grammar::NonTerminal<Family, Category>>, C>> : fmt::formatter<std::string_view>
{
    using View = ygg::View<ygg::Index<runir::kr::dl::grammar::NonTerminal<Family, Category>>, C>;
    auto format(View view, format_context& ctx) const { return fmt::formatter<std::string_view>::format(view.get_name().str(), ctx); }
};

template<runir::kr::dl::FamilyTag Family, runir::kr::dl::CategoryTag Category, typename C>
struct fmt::formatter<ygg::View<ygg::Index<runir::kr::dl::grammar::ConstructorOrNonTerminal<Family, Category>>, C>> : fmt::formatter<std::string_view>
{
    using View = ygg::View<ygg::Index<runir::kr::dl::grammar::ConstructorOrNonTerminal<Family, Category>>, C>;
