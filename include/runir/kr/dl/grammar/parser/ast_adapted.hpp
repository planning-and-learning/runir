#ifndef RUNIR_KR_DL_GRAMMAR_PARSER_AST_ADAPTED_HPP_
#define RUNIR_KR_DL_GRAMMAR_PARSER_AST_ADAPTED_HPP_
...
BOOST_FUSION_ADAPT_TPL_STRUCT((Category), (runir::kr::dl::grammar::parser::ext::ast::Argument)(Category), (ygg::uint_t, identifier))
