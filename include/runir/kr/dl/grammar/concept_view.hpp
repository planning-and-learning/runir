...
class View<Index<runir::kr::dl::grammar::Concept<Family, Tag>>, C>
{
private:
    const C* m_context;
    Index<runir::kr::dl::grammar::Concept<Family, Tag>> m_handle;

public:
    View(Index<runir::kr::dl::grammar::Concept<Family, Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
