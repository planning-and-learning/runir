...
struct Index<runir::kr::dl::cnf_grammar::Boolean<Tag>> : IndexMixin<Index<runir::kr::dl::cnf_grammar::Boolean<Tag>>>
{
    using Base = IndexMixin<Index<runir::kr::dl::cnf_grammar::Boolean<Tag>>>;
    using Base::Base;
};
