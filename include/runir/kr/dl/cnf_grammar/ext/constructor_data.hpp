...
#include "runir/kr/dl/cnf_grammar/ext/concept_data.hpp"
#include "runir/kr/dl/cnf_grammar/ext/constructor_index.hpp"
...
{
    using Variant = ::cista::offset::variant<Index<runir::kr::dl::cnf_grammar::Concept<runir::kr::ExtFamilyTag, runir::kr::dl::BotTag>>,
