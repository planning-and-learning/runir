...
struct Data<runir::kr::ps::ConcreteFeature<runir::kr::UnsFamilyTag, runir::kr::DlTag, runir::kr::ps::dl::BooleanFeature>>
{
    ...
    Data() = default;
    Data(Index<runir::kr::dl::Constructor<runir::kr::UnsFamilyTag, runir::kr::dl::BooleanTag>> feature_, ::cista::offset::string symbol_) :
        index(),
        feature(feature_),
        symbol(std::move(symbol_))
    {
    }
    Data(Index<runir::kr::dl::Constructor<runir::kr::UnsFamilyTag, runir::kr::dl::BooleanTag>> feature_, const std::string& symbol_) :
        index(),
        feature(feature_),
        symbol(symbol_)
    {
