...
class View<Index<runir::grammar::Role<Tag>>, C>
{
private:
    const C* m_context;
    Index<runir::grammar::Role<Tag>> m_handle;

public:
    View(Index<runir::grammar::Role<Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
