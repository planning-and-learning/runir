...
class View<Index<runir::grammar::Concept<Tag>>, C>
{
private:
    const C* m_context;
    Index<runir::grammar::Concept<Tag>> m_handle;

public:
    View(Index<runir::grammar::Concept<Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
