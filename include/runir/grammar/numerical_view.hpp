...
#include "runir/grammar/numerical_data.hpp"
...
class View<Index<runir::grammar::Numerical<Tag>>, C>
{
private:
    const C* m_context;
    Index<runir::grammar::Numerical<Tag>> m_handle;

public:
    View(Index<runir::grammar::Numerical<Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
