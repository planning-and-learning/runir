...
class View<Index<runir::grammar::Boolean<Tag>>, C>
{
private:
    const C* m_context;
    Index<runir::grammar::Boolean<Tag>> m_handle;

public:
    View(Index<runir::grammar::Boolean<Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
