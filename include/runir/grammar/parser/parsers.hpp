...
using concept_type = x3::rule<ConstructorClass<runir::ConceptTag>, ast::Constructor<runir::ConceptTag>>;
using concept_root_type = x3::rule<ConstructorRootClass<runir::ConceptTag>, ast::Constructor<runir::ConceptTag>>;
...
using concept_non_terminal_type = x3::rule<NonTerminalClass<runir::ConceptTag>, ast::NonTerminal<runir::ConceptTag>>;
using concept_choice_type = x3::rule<ConstructorOrNonTerminalClass<runir::ConceptTag>, ast::ConstructorOrNonTerminal<runir::ConceptTag>>;
using concept_derivation_rule_type = x3::rule<DerivationRuleClass<runir::ConceptTag>, ast::DerivationRule<runir::ConceptTag>>;

using role_type = x3::rule<ConstructorClass<runir::RoleTag>, ast::Constructor<runir::RoleTag>>;
using role_root_type = x3::rule<ConstructorRootClass<runir::RoleTag>, ast::Constructor<runir::RoleTag>>;
...
using role_non_terminal_type = x3::rule<NonTerminalClass<runir::RoleTag>, ast::NonTerminal<runir::RoleTag>>;
using role_choice_type = x3::rule<ConstructorOrNonTerminalClass<runir::RoleTag>, ast::ConstructorOrNonTerminal<runir::RoleTag>>;
using role_derivation_rule_type = x3::rule<DerivationRuleClass<runir::RoleTag>, ast::DerivationRule<runir::RoleTag>>;
...
using boolean_type = x3::rule<ConstructorClass<runir::BooleanTag>, ast::Constructor<runir::BooleanTag>>;
using boolean_root_type = x3::rule<ConstructorRootClass<runir::BooleanTag>, ast::Constructor<runir::BooleanTag>>;
...
using boolean_non_terminal_type = x3::rule<NonTerminalClass<runir::BooleanTag>, ast::NonTerminal<runir::BooleanTag>>;
using boolean_choice_type = x3::rule<ConstructorOrNonTerminalClass<runir::BooleanTag>, ast::ConstructorOrNonTerminal<runir::BooleanTag>>;
using boolean_derivation_rule_type = x3::rule<DerivationRuleClass<runir::BooleanTag>, ast::DerivationRule<runir::BooleanTag>>;

using numerical_type = x3::rule<ConstructorClass<runir::NumericalTag>, ast::Constructor<runir::NumericalTag>>;
using numerical_root_type = x3::rule<ConstructorRootClass<runir::NumericalTag>, ast::Constructor<runir::NumericalTag>>;
...
using numerical_non_terminal_type = x3::rule<NonTerminalClass<runir::NumericalTag>, ast::NonTerminal<runir::NumericalTag>>;
using numerical_choice_type = x3::rule<ConstructorOrNonTerminalClass<runir::NumericalTag>, ast::ConstructorOrNonTerminal<runir::NumericalTag>>;
using numerical_derivation_rule_type = x3::rule<DerivationRuleClass<runir::NumericalTag>, ast::DerivationRule<runir::NumericalTag>>;
