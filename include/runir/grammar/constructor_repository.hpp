...
#include "runir/grammar/datas.hpp"
...
using ConceptTypes = tyr::MapTypeListT<Concept, runir::ConceptConstructorTags>;
using RoleTypes = tyr::MapTypeListT<Role, runir::RoleConstructorTags>;
using BooleanTypes = tyr::MapTypeListT<Boolean, runir::BooleanConstructorTags>;
using NumericalTypes = tyr::MapTypeListT<Numerical, runir::NumericalConstructorTags>;
using ConstructorTypes = tyr::MapTypeListT<Constructor, runir::CategoryTags>;
using ConstructorOrNonTerminalTypes = tyr::MapTypeListT<ConstructorOrNonTerminal, runir::CategoryTags>;
using NonTerminalTypes = tyr::MapTypeListT<NonTerminal, runir::CategoryTags>;
using DerivationRuleTypes = tyr::MapTypeListT<DerivationRule, runir::CategoryTags>;
