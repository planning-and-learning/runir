...
#include "runir/knowledge_representation/dl/cnf_grammar/numerical_data.hpp"
...
class View<Index<runir::kr::dl::cnf_grammar::Numerical<Tag>>, C>
{
private:
    const C* m_context;
    Index<runir::kr::dl::cnf_grammar::Numerical<Tag>> m_handle;

public:
    View(Index<runir::kr::dl::cnf_grammar::Numerical<Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
