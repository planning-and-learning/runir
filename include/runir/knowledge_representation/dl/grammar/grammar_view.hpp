...
template<typename C>
class View<Index<runir::kr::dl::grammar::GrammarTag>, C>
{
private:
    const C* m_context;
    Index<runir::kr::dl::grammar::GrammarTag> m_handle;

public:
    View(Index<runir::kr::dl::grammar::GrammarTag> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
