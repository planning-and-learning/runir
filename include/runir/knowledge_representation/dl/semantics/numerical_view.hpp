...
#include "runir/knowledge_representation/dl/semantics/numerical_data.hpp"
...
private:
    const C* m_context;
    Index<runir::kr::dl::Numerical<Tag>> m_handle;

public:
    View(Index<runir::kr::dl::Numerical<Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
