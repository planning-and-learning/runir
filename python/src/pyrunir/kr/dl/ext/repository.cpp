...
void bind_repository(nb::module_& m)
{
    ...
    factory.def(nb::init<>())
        ...
        .def(
            "create",
            [](runir::kr::dl::ExtConstructorRepositoryFactory& self, const tyr::planning::Task<tyr::planning::GroundTag>& task)
            { return self.create(task.get_repository()); },
            nb::arg("ground_task"))
        .def(
            "create",
            [](runir::kr::dl::ExtConstructorRepositoryFactory& self, const tyr::planning::Task<tyr::planning::LiftedTag>& task)
            { return self.create(task.get_repository()); },
            nb::arg("lifted_task"));
}
