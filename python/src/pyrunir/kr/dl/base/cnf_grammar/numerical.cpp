...
{
    using Data = ygg::Data<runir::kr::dl::cnf_grammar::Numerical<runir::kr::BaseFamilyTag, Tag>>;
...
{
    using Type = runir::kr::dl::cnf_grammar::Numerical<runir::kr::BaseFamilyTag, Tag>;
...
{
    using Count = runir::kr::dl::cnf_grammar::Numerical<runir::kr::BaseFamilyTag, CountTag>;
    using Distance = runir::kr::dl::cnf_grammar::Numerical<runir::kr::BaseFamilyTag, DistanceTag>;
