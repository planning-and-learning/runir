...
{
    using Data = ygg::Data<runir::kr::dl::Role<runir::kr::BaseFamilyTag, Tag>>;
...
{
    using Type = runir::kr::dl::Role<runir::kr::BaseFamilyTag, Tag>;
...
{
    using Universal = runir::kr::dl::Role<runir::kr::BaseFamilyTag, UniversalTag>;
    using StaticState = runir::kr::dl::Role<runir::kr::BaseFamilyTag, AtomicStateTag<tyr::formalism::StaticTag>>;
    using FluentState = runir::kr::dl::Role<runir::kr::BaseFamilyTag, AtomicStateTag<tyr::formalism::FluentTag>>;
    using DerivedState = runir::kr::dl::Role<runir::kr::BaseFamilyTag, AtomicStateTag<tyr::formalism::DerivedTag>>;
    using StaticGoal = runir::kr::dl::Role<runir::kr::BaseFamilyTag, AtomicGoalTag<tyr::formalism::StaticTag>>;
    using FluentGoal = runir::kr::dl::Role<runir::kr::BaseFamilyTag, AtomicGoalTag<tyr::formalism::FluentTag>>;
    using DerivedGoal = runir::kr::dl::Role<runir::kr::BaseFamilyTag, AtomicGoalTag<tyr::formalism::DerivedTag>>;
    using Intersection = runir::kr::dl::Role<runir::kr::BaseFamilyTag, IntersectionTag>;
    using Union = runir::kr::dl::Role<runir::kr::BaseFamilyTag, UnionTag>;
    using Complement = runir::kr::dl::Role<runir::kr::BaseFamilyTag, ComplementTag>;
    using Inverse = runir::kr::dl::Role<runir::kr::BaseFamilyTag, InverseTag>;
    using Composition = runir::kr::dl::Role<runir::kr::BaseFamilyTag, CompositionTag>;
    using TransitiveClosure = runir::kr::dl::Role<runir::kr::BaseFamilyTag, TransitiveClosureTag>;
    using ReflexiveTransitiveClosure = runir::kr::dl::Role<runir::kr::BaseFamilyTag, ReflexiveTransitiveClosureTag>;
    using Restriction = runir::kr::dl::Role<runir::kr::BaseFamilyTag, RestrictionTag>;
    using Identity = runir::kr::dl::Role<runir::kr::BaseFamilyTag, IdentityTag>;
