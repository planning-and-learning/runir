...
{
    using Data = ygg::Data<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, Tag>>;
...
{
    using Type = runir::kr::dl::Concept<runir::kr::BaseFamilyTag, Tag>;
...
{
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, BotTag>>>(m, "ConceptBotIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, TopTag>>>(m, "ConceptTopIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, AtomicStateTag<tyr::formalism::StaticTag>>>>(m,
                                                                                                                             "ConceptAtomicStateStaticIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, AtomicStateTag<tyr::formalism::FluentTag>>>>(m,
                                                                                                                             "ConceptAtomicStateFluentIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, AtomicStateTag<tyr::formalism::DerivedTag>>>>(m,
                                                                                                                              "ConceptAtomicStateDerivedIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, AtomicGoalTag<tyr::formalism::StaticTag>>>>(m, "ConceptAtomicGoalStaticIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, AtomicGoalTag<tyr::formalism::FluentTag>>>>(m, "ConceptAtomicGoalFluentIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, AtomicGoalTag<tyr::formalism::DerivedTag>>>>(m,
                                                                                                                             "ConceptAtomicGoalDerivedIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, IntersectionTag>>>(m, "ConceptIntersectionIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, UnionTag>>>(m, "ConceptUnionIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, NegationTag>>>(m, "ConceptNegationIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, ValueRestrictionTag>>>(m, "ConceptValueRestrictionIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, ExistentialQuantificationTag>>>(m, "ConceptExistentialQuantificationIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, AtLeastNumberRestrictionTag>>>(m, "ConceptAtLeastNumberRestrictionIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, AtMostNumberRestrictionTag>>>(m, "ConceptAtMostNumberRestrictionIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, ExactNumberRestrictionTag>>>(m, "ConceptExactNumberRestrictionIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, QualifiedAtLeastNumberRestrictionTag>>>(
        m,
        "ConceptQualifiedAtLeastNumberRestrictionIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, QualifiedAtMostNumberRestrictionTag>>>(
        m,
        "ConceptQualifiedAtMostNumberRestrictionIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, QualifiedExactNumberRestrictionTag>>>(
        m,
        "ConceptQualifiedExactNumberRestrictionIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, RoleValueMapTag>>>(m, "ConceptRoleValueMapIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, AgreementTag>>>(m, "ConceptAgreementIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, RoleFillersTag>>>(m, "ConceptRoleFillersIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, OneOfTag>>>(m, "ConceptOneOfIndex");
    ygg::bind_index<ygg::Index<runir::kr::dl::Concept<runir::kr::BaseFamilyTag, NominalTag>>>(m, "ConceptNominalIndex");
