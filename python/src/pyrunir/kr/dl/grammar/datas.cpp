...
void bind_grammar_datas(nb::module_& m)
{
    ...
    bind_data<runir::kr::dl::grammar::Concept<AtLeastNumberRestrictionTag>>(m, "ConceptAtLeastNumberRestrictionData");
    bind_data<runir::kr::dl::grammar::Concept<AtMostNumberRestrictionTag>>(m, "ConceptAtMostNumberRestrictionData");
    bind_data<runir::kr::dl::grammar::Concept<ExactNumberRestrictionTag>>(m, "ConceptExactNumberRestrictionData");
    bind_data<runir::kr::dl::grammar::Concept<QualifiedAtLeastNumberRestrictionTag>>(m, "ConceptQualifiedAtLeastNumberRestrictionData");
    bind_data<runir::kr::dl::grammar::Concept<QualifiedAtMostNumberRestrictionTag>>(m, "ConceptQualifiedAtMostNumberRestrictionData");
    bind_data<runir::kr::dl::grammar::Concept<QualifiedExactNumberRestrictionTag>>(m, "ConceptQualifiedExactNumberRestrictionData");
    bind_data<runir::kr::dl::grammar::Concept<RoleValueMapTag>>(m, "ConceptRoleValueMapData");
    bind_data<runir::kr::dl::grammar::Concept<AgreementTag>>(m, "ConceptAgreementData");
    bind_data<runir::kr::dl::grammar::Concept<RoleFillersTag>>(m, "ConceptRoleFillersData");
    bind_data<runir::kr::dl::grammar::Concept<OneOfTag>>(m, "ConceptOneOfData");
    ...
    bind_data<runir::kr::dl::grammar::Boolean<AtomicGoalTag<tyr::formalism::StaticTag>>>(m, "BooleanAtomicGoalStaticData");
    bind_data<runir::kr::dl::grammar::Boolean<AtomicGoalTag<tyr::formalism::FluentTag>>>(m, "BooleanAtomicGoalFluentData");
    bind_data<runir::kr::dl::grammar::Boolean<AtomicGoalTag<tyr::formalism::DerivedTag>>>(m, "BooleanAtomicGoalDerivedData");
    ...
    bind_data<runir::kr::dl::grammar::NonTerminal<ConceptTag>>(m, "ConceptNonTerminalData");
    bind_data<runir::kr::dl::grammar::NonTerminal<RoleTag>>(m, "RoleNonTerminalData");
    bind_data<runir::kr::dl::grammar::NonTerminal<BooleanTag>>(m, "BooleanNonTerminalData");
    bind_data<runir::kr::dl::grammar::NonTerminal<NumericalTag>>(m, "NumericalNonTerminalData");
    bind_data<runir::kr::dl::grammar::ConstructorOrNonTerminal<ConceptTag>>(m, "ConceptConstructorOrNonTerminalData");
    bind_data<runir::kr::dl::grammar::ConstructorOrNonTerminal<RoleTag>>(m, "RoleConstructorOrNonTerminalData");
    bind_data<runir::kr::dl::grammar::ConstructorOrNonTerminal<BooleanTag>>(m, "BooleanConstructorOrNonTerminalData");
    bind_data<runir::kr::dl::grammar::ConstructorOrNonTerminal<NumericalTag>>(m, "NumericalConstructorOrNonTerminalData");
}
