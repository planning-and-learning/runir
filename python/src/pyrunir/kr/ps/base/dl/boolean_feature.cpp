...
{
    using Feature = runir::kr::ps::Feature<runir::kr::BaseFamilyTag, runir::kr::ps::dl::BooleanFeature>;
    using FeatureData = ygg::Data<Feature>;
    using FeatureView = ygg::View<ygg::Index<Feature>, Repository>;
    using ConcreteFeature = runir::kr::ps::ConcreteFeature<runir::kr::BaseFamilyTag, runir::kr::DlTag, runir::kr::ps::dl::BooleanFeature>;
    ...
    auto feature = nb::class_<FeatureView>(m, "BooleanFeature")
    ...
    auto concrete_feature = nb::class_<ConcreteFeatureView>(m, "ConcreteBooleanFeature")
