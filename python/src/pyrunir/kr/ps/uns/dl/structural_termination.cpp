...
#include <optional>
#include <runir/kr/ps/uns/dl/incomplete_structural_termination.hpp>
...
{
    // NumericalChange is the family-agnostic enum runir::kr::ps::dl::NumericalChange; it is already
    // registered by the base bindings, so we must not register it again here.
