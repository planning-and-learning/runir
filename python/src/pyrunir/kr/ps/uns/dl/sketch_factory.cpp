...
void bind_sketch_factory(nb::module_& m)
{
    ...
    nb::class_<SketchFactory>(m, "SketchFactory")
        ...
        .def_static(
            "create",
            [](SketchSpecification specification, tyr::formalism::planning::PlanningDomain domain, runir::kr::ps::uns::Repository& repository)
        ...
        .def_static(
            ...
            [](tyr::formalism::planning::PlanningDomain domain, runir::kr::ps::uns::Repository& repository)
