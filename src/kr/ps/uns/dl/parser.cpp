...
{
    if constexpr (requires { runir::kr::ps::uns::canonicalize(data); })
        runir::kr::ps::uns::canonicalize(data);
...
using BooleanFeatureMap = std::unordered_map<std::string, ygg::Index<runir::kr::ps::Feature<runir::kr::UnsFamilyTag, runir::kr::ps::dl::BooleanFeature>>>;
using NumericalFeatureMap = std::unordered_map<std::string, ygg::Index<runir::kr::ps::Feature<runir::kr::UnsFamilyTag, runir::kr::ps::dl::NumericalFeature>>>;

auto parse_feature(const runir::kr::ps::uns::dl::ast::BooleanFeature<runir::kr::UnsFamilyTag>& node,
                   tyr::formalism::planning::DomainView domain,
                   Repository& repository,
                   BooleanFeatureMap& boolean_features,
                   NumericalFeatureMap&)
{
    ygg::Data<runir::kr::ps::ConcreteFeature<runir::kr::UnsFamilyTag, runir::kr::DlTag, runir::kr::ps::dl::BooleanFeature>> concrete_data(
    ...
    ygg::Data<runir::kr::ps::Feature<runir::kr::UnsFamilyTag, runir::kr::ps::dl::BooleanFeature>> data(concrete.get_index());
    auto feature = intern(repository, data);
    boolean_features.emplace(node.symbol, feature.get_index());
}

auto parse_feature(const runir::kr::ps::uns::dl::ast::NumericalFeature<runir::kr::UnsFamilyTag>& node,
                   tyr::formalism::planning::DomainView domain,
                   Repository& repository,
                   BooleanFeatureMap&,
                   NumericalFeatureMap& numerical_features)
{
    ygg::Data<runir::kr::ps::ConcreteFeature<runir::kr::UnsFamilyTag, runir::kr::DlTag, runir::kr::ps::dl::NumericalFeature>> concrete_data(
        parse_constructor(node.feature, domain, repository.get_dl_repository()).get_index(),
        node.symbol,
        node.description);
    auto concrete = intern(repository, concrete_data);
    ygg::Data<runir::kr::ps::Feature<runir::kr::UnsFamilyTag, runir::kr::ps::dl::NumericalFeature>> data(concrete.get_index());
    auto feature = intern(repository, data);
    numerical_features.emplace(node.symbol, feature.get_index());
}

template<typename FeatureTag>
auto require_feature(const std::unordered_map<std::string, ygg::Index<runir::kr::ps::Feature<runir::kr::UnsFamilyTag, FeatureTag>>>& features,
...
auto make_condition(ygg::Index<runir::kr::ps::Feature<runir::kr::UnsFamilyTag, FeatureTag>> feature, Repository& repository)
{
    ygg::Data<runir::kr::ps::ConcreteCondition<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag, ObservationTag>> concrete_data(feature);
    auto concrete = intern(repository, concrete_data);
    ygg::Data<runir::kr::ps::ConcreteConditionVariant<runir::kr::UnsFamilyTag, runir::kr::DlTag>> variant_data(concrete.get_index());
    auto variant = intern(repository, variant_data);
    ygg::Data<runir::kr::ps::ConditionVariant<runir::kr::UnsFamilyTag>> data(variant.get_index());
    return intern(repository, data);
}

template<typename FeatureTag, typename ObservationTag>
auto make_effect(ygg::Index<runir::kr::ps::Feature<runir::kr::UnsFamilyTag, FeatureTag>> feature, Repository& repository)
{
    ygg::Data<runir::kr::ps::ConcreteEffect<runir::kr::UnsFamilyTag, runir::kr::DlTag, FeatureTag, ObservationTag>> concrete_data(feature);
    auto concrete = intern(repository, concrete_data);
    ygg::Data<runir::kr::ps::ConcreteEffectVariant<runir::kr::UnsFamilyTag, runir::kr::DlTag>> variant_data(concrete.get_index());
    auto variant = intern(repository, variant_data);
    ygg::Data<runir::kr::ps::EffectVariant<runir::kr::UnsFamilyTag>> data(variant.get_index());
    return intern(repository, data);
}

auto parse_condition_observation(const runir::kr::ps::uns::dl::ast::Positive&,
...
auto parse_condition_observation(const runir::kr::ps::uns::dl::ast::Negative&,
                                 const std::string& feature,
                                 Repository& repository,
                                 const BooleanFeatureMap& boolean_features,
                                 const NumericalFeatureMap&)
...
auto parse_condition_observation(const runir::kr::ps::uns::dl::ast::EqualZero&,
                                 const std::string& feature,
                                 Repository& repository,
...
auto parse_condition_observation(const runir::kr::ps::uns::dl::ast::GreaterZero&,
                                 const std::string& feature,
                                 Repository& repository,
                                 const BooleanFeatureMap&,
                                 const NumericalFeatureMap& numerical_features)
...
auto parse_condition(const runir::kr::ps::uns::dl::ast::Condition<runir::kr::UnsFamilyTag>& node,
                     Repository& repository,
                     const BooleanFeatureMap& boolean_features,
                     const NumericalFeatureMap& numerical_features)
{
...
auto parse_effect_observation(const runir::kr::ps::uns::dl::ast::Positive&,
                              const std::string& feature,
                              Repository& repository,
                              const BooleanFeatureMap& boolean_features,
                              const NumericalFeatureMap&)
...
auto parse_effect_observation(const runir::kr::ps::uns::dl::ast::Negative&,
                              const std::string& feature,
                              Repository& repository,
                              const BooleanFeatureMap& boolean_features,
                              const NumericalFeatureMap&)
...
auto parse_effect_observation(const runir::kr::ps::uns::dl::ast::Unchanged&,
                              const std::string& feature,
                              Repository& repository,
                              const BooleanFeatureMap& boolean_features,
                              const NumericalFeatureMap& numerical_features)
...
auto parse_effect_observation(const runir::kr::ps::uns::dl::ast::Increases&,
                              const std::string& feature,
                              Repository& repository,
                              const BooleanFeatureMap&,
                              const NumericalFeatureMap& numerical_features)
...
auto parse_effect_observation(const runir::kr::ps::uns::dl::ast::Decreases&,
                              const std::string& feature,
                              Repository& repository,
                              const BooleanFeatureMap&,
                              const NumericalFeatureMap& numerical_features)
...
auto parse_effect(const runir::kr::ps::uns::dl::ast::Effect<runir::kr::UnsFamilyTag>& node,
                  Repository& repository,
                  const BooleanFeatureMap& boolean_features,
                  const NumericalFeatureMap& numerical_features)
{
...
auto parse_rule(const runir::kr::ps::uns::dl::ast::Rule<runir::kr::UnsFamilyTag>& node,
                Repository& repository,
                const BooleanFeatureMap& boolean_features,
                const NumericalFeatureMap& numerical_features)
{
    auto conditions = ygg::IndexList<runir::kr::ps::ConditionVariant<runir::kr::UnsFamilyTag>> {};
    ...
    auto effects = ygg::IndexList<runir::kr::ps::EffectVariant<runir::kr::UnsFamilyTag>> {};
    ...
    ygg::Data<runir::kr::ps::uns::Rule> data(node.symbol, node.description);
