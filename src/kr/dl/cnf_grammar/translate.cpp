...
auto intern(ConstructorRepositoryFor<Family>& repository, tyr::Data<T>& data)
{
    canonicalize(data);
...
auto intern_constructor(ConstructorRepositoryFor<Family>& repository, tyr::Index<T> index)
{
...
struct TranslationContext
{
    ...
    tyr::Data<Grammar<Family>> data;
    std::unordered_set<std::string> non_terminal_names;
    size_t next_fresh_index = 0;

    TranslationContext(const runir::kr::dl::grammar::GrammarView& source_, ConstructorRepositoryFor<Family>& repository_) :
        source(source_),
...
private:
    ...
    auto make_fresh_non_terminal()
    {
        ...
        tyr::Data<NonTerminal<Family, Category>> data(name);
        return intern(repository(), data);
    }

    void add_derivation_rule(FamilyNonTerminalView<Family, Category> lhs, FamilyConstructorView<Family, Category> rhs)
    {
        tyr::Data<DerivationRule<Family, Category>> data(lhs.get_index(), rhs.get_index());
    ...
    {
        tyr::Data<SubstitutionRule<Family, Category>> data(lhs.get_index(), rhs.get_index());
...
public:
    ...
    {
        return tyr::visit([&](auto value) { return translate_concrete_constructor(value); }, source.get_variant());
    }
    ...
    {
        tyr::Data<Concept<Family, runir::kr::dl::BotTag>> data;
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::TopTag>)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::TopTag>> data;
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::AtomicStateTag<T>> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::AtomicStateTag<T>>> data(source.get_data().predicate, source.get_data().polarity);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::AtomicGoalTag<T>> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::AtomicGoalTag<T>>> data(source.get_data().predicate, source.get_data().polarity);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::IntersectionTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::IntersectionTag>> data(translate_to_non_terminal(source.get_lhs()).get_index(),
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::UnionTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::UnionTag>> data(translate_to_non_terminal(source.get_lhs()).get_index(),
                                                                 translate_to_non_terminal(source.get_rhs()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::NegationTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::NegationTag>> data(translate_to_non_terminal(source.get_arg()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::ValueRestrictionTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::ValueRestrictionTag>> data(translate_child<runir::kr::dl::RoleTag>(source.get_lhs()).get_index(),
                                                                            translate_to_non_terminal(source.get_rhs()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::ExistentialQuantificationTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::ExistentialQuantificationTag>> data(translate_child<runir::kr::dl::RoleTag>(source.get_lhs()).get_index(),
                                                                                     translate_to_non_terminal(source.get_rhs()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::AtLeastNumberRestrictionTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::AtLeastNumberRestrictionTag>> data(source.get_n(),
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::AtMostNumberRestrictionTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::AtMostNumberRestrictionTag>> data(source.get_n(),
                                                                                   translate_child<runir::kr::dl::RoleTag>(source.get_role()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::ExactNumberRestrictionTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::ExactNumberRestrictionTag>> data(source.get_n(),
                                                                                  translate_child<runir::kr::dl::RoleTag>(source.get_role()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::QualifiedAtLeastNumberRestrictionTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::QualifiedAtLeastNumberRestrictionTag>> data(
            source.get_n(),
            translate_child<runir::kr::dl::RoleTag>(source.get_role()).get_index(),
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::QualifiedAtMostNumberRestrictionTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::QualifiedAtMostNumberRestrictionTag>> data(
            source.get_n(),
            translate_child<runir::kr::dl::RoleTag>(source.get_role()).get_index(),
            translate_to_non_terminal(source.get_concept()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::QualifiedExactNumberRestrictionTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::QualifiedExactNumberRestrictionTag>> data(
            source.get_n(),
            translate_child<runir::kr::dl::RoleTag>(source.get_role()).get_index(),
            translate_to_non_terminal(source.get_concept()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::RoleValueMapTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::RoleValueMapTag>> data(translate_child<runir::kr::dl::RoleTag>(source.get_lhs()).get_index(),
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::AgreementTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::AgreementTag>> data(translate_child<runir::kr::dl::RoleTag>(source.get_lhs()).get_index(),
                                                                     translate_child<runir::kr::dl::RoleTag>(source.get_rhs()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::RoleFillersTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::RoleFillersTag>> data(translate_child<runir::kr::dl::RoleTag>(source.get_role()).get_index(),
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::OneOfTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::OneOfTag>> data(source.get_data().objects);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::ConceptView<runir::kr::dl::NominalTag> source)
        requires std::same_as<Category, runir::kr::dl::ConceptTag>
    {
        tyr::Data<Concept<Family, runir::kr::dl::NominalTag>> data(source.get_data().object);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    {
        tyr::Data<Role<Family, runir::kr::dl::UniversalTag>> data;
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::AtomicStateTag<T>> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::AtomicStateTag<T>>> data(source.get_data().predicate, source.get_data().polarity);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::AtomicGoalTag<T>> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::AtomicGoalTag<T>>> data(source.get_data().predicate, source.get_data().polarity);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::IntersectionTag> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::IntersectionTag>> data(translate_to_non_terminal(source.get_lhs()).get_index(),
                                                                     translate_to_non_terminal(source.get_rhs()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::UnionTag> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::UnionTag>> data(translate_to_non_terminal(source.get_lhs()).get_index(),
                                                              translate_to_non_terminal(source.get_rhs()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::ComplementTag> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::ComplementTag>> data(translate_to_non_terminal(source.get_arg()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::InverseTag> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::InverseTag>> data(translate_to_non_terminal(source.get_arg()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::CompositionTag> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::CompositionTag>> data(translate_to_non_terminal(source.get_lhs()).get_index(),
                                                                    translate_to_non_terminal(source.get_rhs()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::TransitiveClosureTag> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::TransitiveClosureTag>> data(translate_to_non_terminal(source.get_arg()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::ReflexiveTransitiveClosureTag> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::ReflexiveTransitiveClosureTag>> data(translate_to_non_terminal(source.get_arg()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::RestrictionTag> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::RestrictionTag>> data(translate_to_non_terminal(source.get_lhs()).get_index(),
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::RoleView<runir::kr::dl::IdentityTag> source)
        requires std::same_as<Category, runir::kr::dl::RoleTag>
    {
        tyr::Data<Role<Family, runir::kr::dl::IdentityTag>> data(translate_child<runir::kr::dl::ConceptTag>(source.get_arg()).get_index());
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    {
        tyr::Data<Boolean<Family, runir::kr::dl::AtomicStateTag<T>>> data(source.get_data().predicate, source.get_data().polarity);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::BooleanView<runir::kr::dl::AtomicGoalTag<T>> source)
        requires std::same_as<Category, runir::kr::dl::BooleanTag>
    {
        tyr::Data<Boolean<Family, runir::kr::dl::AtomicGoalTag<T>>> data(source.get_data().predicate, source.get_data().polarity);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::BooleanView<runir::kr::dl::NonemptyTag> source)
        requires std::same_as<Category, runir::kr::dl::BooleanTag>
    {
        const auto arg = tyr::visit(
            [&](auto value) -> typename tyr::Data<Boolean<Family, runir::kr::dl::NonemptyTag>>::Arg
            {
                using View = std::decay_t<decltype(value)>;
        ...
        tyr::Data<Boolean<Family, runir::kr::dl::NonemptyTag>> data(arg);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    {
        const auto arg = tyr::visit(
            [&](auto value) -> typename tyr::Data<Numerical<Family, runir::kr::dl::CountTag>>::Arg
            {
                using View = std::decay_t<decltype(value)>;
                if constexpr (std::same_as<View, runir::kr::dl::grammar::ConstructorOrNonTerminalView<runir::kr::dl::ConceptTag>>)
                    return translate_child<runir::kr::dl::ConceptTag>(value).get_index();
        ...
        tyr::Data<Numerical<Family, runir::kr::dl::CountTag>> data(arg);
        return intern_constructor<Family, Category>(repository(), intern(repository(), data).get_index());
    }
    ...
    auto translate_concrete_constructor(runir::kr::dl::grammar::NumericalView<runir::kr::dl::DistanceTag> source)
        requires std::same_as<Category, runir::kr::dl::NumericalTag>
    {
        tyr::Data<Numerical<Family, runir::kr::dl::DistanceTag>> data(translate_child<runir::kr::dl::ConceptTag>(source.get_lhs()).get_index(),
...
template<runir::kr::dl::FamilyTag Family>
auto translate_impl(const runir::kr::dl::grammar::GrammarView& grammar, ConstructorRepositoryFor<Family>& repository)
{
...
{
    return translate_impl<runir::kr::BaseFamilyTag>(grammar, repository);
}
