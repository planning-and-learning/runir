...
BOOST_SPIRIT_INSTANTIATE(concept_at_least_number_restriction_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(concept_at_most_number_restriction_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(concept_exact_number_restriction_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(concept_qualified_at_least_number_restriction_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(concept_qualified_at_most_number_restriction_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(concept_qualified_exact_number_restriction_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(concept_role_value_map_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(concept_agreement_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(concept_role_fillers_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(concept_one_of_type, iterator_type, context_type)
...
BOOST_SPIRIT_INSTANTIATE(boolean_atomic_goal_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_nonempty_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_eq_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_neq_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_lt_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_le_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_gt_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_ge_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_constant_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_and_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_or_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(boolean_not_type, iterator_type, context_type)
...
BOOST_SPIRIT_INSTANTIATE(numerical_eq_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_neq_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_lt_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_le_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_gt_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_ge_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_constant_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_add_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_sub_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_mul_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_div_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_min_type, iterator_type, context_type)
BOOST_SPIRIT_INSTANTIATE(numerical_max_type, iterator_type, context_type)
