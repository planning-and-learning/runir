...
inline auto object_name_string_parser()
{
...
#define RUNIR_DEFINE_FAMILY_PARSER(Family, prefix)                                                                                                  \
    ...
    constructor_tag_type<Family, runir::kr::dl::ConceptTag, runir::kr::dl::ExistentialQuantificationTag> const                                      \
        prefix##_concept_existential_quantification = "concept_existential_quantification";                                                         \
    constructor_tag_type<Family, runir::kr::dl::ConceptTag, runir::kr::dl::AtLeastNumberRestrictionTag> const                                       \
        prefix##_concept_at_least_number_restriction = "concept_at_least_number_restriction";                                                      \
    constructor_tag_type<Family, runir::kr::dl::ConceptTag, runir::kr::dl::AtMostNumberRestrictionTag> const                                        \
        prefix##_concept_at_most_number_restriction = "concept_at_most_number_restriction";                                                        \
    ...
    constructor_tag_type<Family, runir::kr::dl::ConceptTag, runir::kr::dl::RoleValueMapTag> const prefix##_concept_role_value_map =                 \
    ...
    constructor_tag_type<Family, runir::kr::dl::ConceptTag, runir::kr::dl::RoleFillersTag> const prefix##_concept_role_fillers =                   \
    ...
    constructor_tag_type<Family, runir::kr::dl::RoleTag, runir::kr::dl::ArgumentTag<runir::kr::dl::RoleTag>> const prefix##_role_argument =         \
        "role_argument";                                                                                                                            \
    ...
    const auto prefix##_concept_def =                                                                                                                \
        ...
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::ConceptTag, runir::kr::dl::ExistentialQuantificationTag>>(prefix##_concept_existential_quantification) \
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::ConceptTag, runir::kr::dl::AtLeastNumberRestrictionTag>>(prefix##_concept_at_least_number_restriction) \
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::ConceptTag, runir::kr::dl::AtMostNumberRestrictionTag>>(prefix##_concept_at_most_number_restriction) \
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::ConceptTag, runir::kr::dl::ExactNumberRestrictionTag>>(prefix##_concept_exact_number_restriction) \
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::ConceptTag, runir::kr::dl::QualifiedAtLeastNumberRestrictionTag>>(prefix##_concept_qualified_at_least_number_restriction) \
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::ConceptTag, runir::kr::dl::QualifiedAtMostNumberRestrictionTag>>(prefix##_concept_qualified_at_most_number_restriction) \
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::ConceptTag, runir::kr::dl::QualifiedExactNumberRestrictionTag>>(prefix##_concept_qualified_exact_number_restriction) \
        ...
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::ConceptTag, runir::kr::dl::ArgumentTag<runir::kr::dl::ConceptTag>>>(prefix##_concept_argument); \
    ...
    const auto prefix##_role_def =                                                                                                                   \
        ...
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::RoleTag, runir::kr::dl::ReflexiveTransitiveClosureTag>>(prefix##_role_reflexive_transitive_closure) \
    ...
    const auto prefix##_boolean_def =                                                                                                                \
        ...
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::BooleanTag, runir::kr::dl::ArgumentTag<runir::kr::dl::BooleanTag>>>(prefix##_boolean_argument); \
    ...
    const auto prefix##_numerical_def =                                                                                                              \
        ...
        | maybe<has_ast_constructor_tag_v<Family, runir::kr::dl::NumericalTag, runir::kr::dl::ArgumentTag<runir::kr::dl::NumericalTag>>>(prefix##_numerical_argument); \
    ...
    const auto prefix##_concept_bot_def = with_constructor_parentheses(lit(grammar_ast::ConceptBot<Family>::keyword) >> x3::attr(grammar_ast::ConceptBot<Family> {})); \
    const auto prefix##_concept_top_def = with_constructor_parentheses(lit(grammar_ast::ConceptTop<Family>::keyword) >> x3::attr(grammar_ast::ConceptTop<Family> {})); \
    const auto prefix##_concept_atomic_state_def = with_constructor_parentheses(lit(grammar_ast::ConceptAtomicState<Family>::keyword) > predicate_name_string_parser()); \
    const auto prefix##_concept_atomic_goal_def = with_constructor_parentheses(lit(grammar_ast::ConceptAtomicGoal<Family>::keyword) > predicate_name_string_parser() > bool_string_parser()); \
    const auto prefix##_concept_intersection_def = with_constructor_parentheses(lit(grammar_ast::ConceptIntersection<Family>::keyword) > prefix##_concept_choice > prefix##_concept_choice); \
    const auto prefix##_concept_union_def = with_constructor_parentheses(lit(grammar_ast::ConceptUnion<Family>::keyword) > prefix##_concept_choice > prefix##_concept_choice); \
    ...
    const auto prefix##_concept_value_restriction_def = with_constructor_parentheses(lit(grammar_ast::ConceptValueRestriction<Family>::keyword) > prefix##_role_choice > prefix##_concept_choice); \
    const auto prefix##_concept_existential_quantification_def = with_constructor_parentheses(lit(grammar_ast::ConceptExistentialQuantification<Family>::keyword) > prefix##_role_choice > prefix##_concept_choice); \
    const auto prefix##_concept_at_least_number_restriction_def = with_constructor_parentheses(lit(grammar_ast::ConceptAtLeastNumberRestriction<Family>::keyword) > uint_ > prefix##_role_choice); \
    const auto prefix##_concept_at_most_number_restriction_def = with_constructor_parentheses(lit(grammar_ast::ConceptAtMostNumberRestriction<Family>::keyword) > uint_ > prefix##_role_choice); \
    const auto prefix##_concept_exact_number_restriction_def = with_constructor_parentheses(lit(grammar_ast::ConceptExactNumberRestriction<Family>::keyword) > uint_ > prefix##_role_choice); \
    const auto prefix##_concept_qualified_at_least_number_restriction_def = with_constructor_parentheses(lit(grammar_ast::ConceptQualifiedAtLeastNumberRestriction<Family>::keyword) > uint_ > prefix##_role_choice > prefix##_concept_choice); \
    const auto prefix##_concept_qualified_at_most_number_restriction_def = with_constructor_parentheses(lit(grammar_ast::ConceptQualifiedAtMostNumberRestriction<Family>::keyword) > uint_ > prefix##_role_choice > prefix##_concept_choice); \
    const auto prefix##_concept_qualified_exact_number_restriction_def = with_constructor_parentheses(lit(grammar_ast::ConceptQualifiedExactNumberRestriction<Family>::keyword) > uint_ > prefix##_role_choice > prefix##_concept_choice); \
    const auto prefix##_concept_role_value_map_def = with_constructor_parentheses(lit(grammar_ast::ConceptRoleValueMap<Family>::keyword) > prefix##_role_choice > prefix##_role_choice); \
    const auto prefix##_concept_agreement_def = with_constructor_parentheses(lit(grammar_ast::ConceptAgreement<Family>::keyword) > prefix##_role_choice > prefix##_role_choice); \
    const auto prefix##_concept_role_fillers_def = with_constructor_parentheses(lit(grammar_ast::ConceptRoleFillers<Family>::keyword) > prefix##_role_choice > +object_name_string_parser()); \
    ...
    const auto prefix##_concept_register_def = constructor_identifier_parser<grammar_ast::ConceptRegister<Family>>(uint_);                          \
    const auto prefix##_concept_argument_def = constructor_identifier_parser<grammar_ast::ConceptArgument<Family>>(uint_);                          \
    const auto prefix##_role_universal_def = with_constructor_parentheses(lit(grammar_ast::RoleUniversal<Family>::keyword) >> x3::attr(grammar_ast::RoleUniversal<Family> {})); \
    const auto prefix##_role_atomic_state_def = with_constructor_parentheses(lit(grammar_ast::RoleAtomicState<Family>::keyword) > predicate_name_string_parser()); \
    const auto prefix##_role_atomic_goal_def = with_constructor_parentheses(lit(grammar_ast::RoleAtomicGoal<Family>::keyword) > predicate_name_string_parser() > bool_string_parser()); \
    const auto prefix##_role_intersection_def = with_constructor_parentheses(lit(grammar_ast::RoleIntersection<Family>::keyword) > prefix##_role_choice > prefix##_role_choice); \
    const auto prefix##_role_union_def = with_constructor_parentheses(lit(grammar_ast::RoleUnion<Family>::keyword) > prefix##_role_choice > prefix##_role_choice); \
    ...
    const auto prefix##_role_composition_def = with_constructor_parentheses(lit(grammar_ast::RoleComposition<Family>::keyword) > prefix##_role_choice > prefix##_role_choice); \
    const auto prefix##_role_transitive_closure_def = with_constructor_parentheses(lit(grammar_ast::RoleTransitiveClosure<Family>::keyword) > prefix##_role_choice); \
    const auto prefix##_role_reflexive_transitive_closure_def = with_constructor_parentheses(lit(grammar_ast::RoleReflexiveTransitiveClosure<Family>::keyword) > prefix##_role_choice); \
    const auto prefix##_role_restriction_def = with_constructor_parentheses(lit(grammar_ast::RoleRestriction<Family>::keyword) > prefix##_role_choice > prefix##_concept_choice); \
    ...
    const auto prefix##_role_register_def = constructor_identifier_parser<grammar_ast::RoleRegister<Family>>(uint_);                                \
    const auto prefix##_role_argument_def = constructor_identifier_parser<grammar_ast::RoleArgument<Family>>(uint_);                                \
    const auto prefix##_boolean_atomic_state_def = with_constructor_parentheses(lit(grammar_ast::BooleanAtomicState<Family>::keyword) > predicate_name_string_parser() > bool_string_parser()); \
    const auto prefix##_boolean_atomic_goal_def = with_constructor_parentheses(lit(grammar_ast::BooleanAtomicGoal<Family>::keyword) > predicate_name_string_parser() > bool_string_parser()); \
    const auto prefix##_boolean_nonempty_def = with_constructor_parentheses(lit(grammar_ast::BooleanNonempty<Family>::keyword) > prefix##_constructor_or_non_terminal_variant); \
    const auto prefix##_boolean_eq_def = with_constructor_parentheses(lit(grammar_ast::BooleanEq<Family>::keyword) > prefix##_boolean_choice > prefix##_boolean_choice); \
    const auto prefix##_boolean_neq_def = with_constructor_parentheses(lit(grammar_ast::BooleanNeq<Family>::keyword) > prefix##_boolean_choice > prefix##_boolean_choice); \
    const auto prefix##_boolean_lt_def = with_constructor_parentheses(lit(grammar_ast::BooleanLt<Family>::keyword) > prefix##_boolean_choice > prefix##_boolean_choice); \
    const auto prefix##_boolean_le_def = with_constructor_parentheses(lit(grammar_ast::BooleanLe<Family>::keyword) > prefix##_boolean_choice > prefix##_boolean_choice); \
    const auto prefix##_boolean_gt_def = with_constructor_parentheses(lit(grammar_ast::BooleanGt<Family>::keyword) > prefix##_boolean_choice > prefix##_boolean_choice); \
    const auto prefix##_boolean_ge_def = with_constructor_parentheses(lit(grammar_ast::BooleanGe<Family>::keyword) > prefix##_boolean_choice > prefix##_boolean_choice); \
    const auto prefix##_numerical_eq_def = with_constructor_parentheses(lit(grammar_ast::NumericalEq<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_neq_def = with_constructor_parentheses(lit(grammar_ast::NumericalNeq<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_lt_def = with_constructor_parentheses(lit(grammar_ast::NumericalLt<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_le_def = with_constructor_parentheses(lit(grammar_ast::NumericalLe<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_gt_def = with_constructor_parentheses(lit(grammar_ast::NumericalGt<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_ge_def = with_constructor_parentheses(lit(grammar_ast::NumericalGe<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    ...
    const auto prefix##_boolean_and_def = with_constructor_parentheses(lit(grammar_ast::BooleanAnd<Family>::keyword) > prefix##_boolean_choice > prefix##_boolean_choice); \
    const auto prefix##_boolean_or_def = with_constructor_parentheses(lit(grammar_ast::BooleanOr<Family>::keyword) > prefix##_boolean_choice > prefix##_boolean_choice); \
    ...
    const auto prefix##_boolean_argument_def = constructor_identifier_parser<grammar_ast::BooleanArgument<Family>>(uint_);                          \
    const auto prefix##_numerical_count_def = with_constructor_parentheses(lit(grammar_ast::NumericalCount<Family>::keyword) > prefix##_constructor_or_non_terminal_variant); \
    const auto prefix##_numerical_distance_def = with_constructor_parentheses(lit(grammar_ast::NumericalDistance<Family>::keyword) > prefix##_concept_choice > prefix##_role_choice > prefix##_concept_choice); \
    ...
    const auto prefix##_numerical_add_def = with_constructor_parentheses(lit(grammar_ast::NumericalAdd<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_sub_def = with_constructor_parentheses(lit(grammar_ast::NumericalSub<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_mul_def = with_constructor_parentheses(lit(grammar_ast::NumericalMul<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_div_def = with_constructor_parentheses(lit(grammar_ast::NumericalDiv<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_min_def = with_constructor_parentheses(lit(grammar_ast::NumericalMin<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_max_def = with_constructor_parentheses(lit(grammar_ast::NumericalMax<Family>::keyword) > prefix##_numerical_choice > prefix##_numerical_choice); \
    const auto prefix##_numerical_argument_def = constructor_identifier_parser<grammar_ast::NumericalArgument<Family>>(uint_);                      \
    const auto prefix##_concept_derivation_rule_def = (lit("(") >> prefix##_concept_non_terminal) > ((lit("(") > (prefix##_concept_choice % lit("or")) > lit(")")) | x3::repeat(1)[prefix##_concept_choice]) > lit(")"); \
    const auto prefix##_role_derivation_rule_def = (lit("(") >> prefix##_role_non_terminal) > ((lit("(") > (prefix##_role_choice % lit("or")) > lit(")")) | x3::repeat(1)[prefix##_role_choice]) > lit(")"); \
    const auto prefix##_boolean_derivation_rule_def = (lit("(") >> prefix##_boolean_non_terminal) > ((lit("(") > (prefix##_boolean_choice % lit("or")) > lit(")")) | x3::repeat(1)[prefix##_boolean_choice]) > lit(")"); \
    const auto prefix##_numerical_derivation_rule_def = (lit("(") >> prefix##_numerical_non_terminal) > ((lit("(") > (prefix##_numerical_choice % lit("or")) > lit(")")) | x3::repeat(1)[prefix##_numerical_choice]) > lit(")"); \
    const auto prefix##_derivation_rule_variant_def = prefix##_concept_derivation_rule | prefix##_role_derivation_rule | prefix##_boolean_derivation_rule | prefix##_numerical_derivation_rule; \
    ...
    BOOST_SPIRIT_DEFINE(prefix##_concept, prefix##_concept_root, prefix##_role, prefix##_role_root, prefix##_boolean, prefix##_boolean_root, prefix##_numerical, prefix##_numerical_root, prefix##_concept_non_terminal, prefix##_concept_choice, prefix##_role_non_terminal, prefix##_role_choice, prefix##_boolean_non_terminal, prefix##_boolean_choice, prefix##_numerical_non_terminal, prefix##_numerical_choice, prefix##_constructor_or_non_terminal_variant, prefix##_concept_derivation_rule, prefix##_role_derivation_rule, prefix##_boolean_derivation_rule, prefix##_numerical_derivation_rule, prefix##_derivation_rule_variant, prefix##_grammar_body, prefix##_grammar, prefix##_grammar_root) \
    BOOST_SPIRIT_DEFINE(prefix##_concept_bot, prefix##_concept_top, prefix##_concept_atomic_state, prefix##_concept_atomic_goal, prefix##_concept_intersection, prefix##_concept_union, prefix##_concept_negation, prefix##_concept_value_restriction, prefix##_concept_existential_quantification, prefix##_concept_at_least_number_restriction, prefix##_concept_at_most_number_restriction, prefix##_concept_exact_number_restriction, prefix##_concept_qualified_at_least_number_restriction, prefix##_concept_qualified_at_most_number_restriction, prefix##_concept_qualified_exact_number_restriction, prefix##_concept_role_value_map, prefix##_concept_agreement, prefix##_concept_role_fillers, prefix##_concept_one_of, prefix##_concept_nominal, prefix##_concept_register, prefix##_concept_argument) \
    BOOST_SPIRIT_DEFINE(prefix##_role_universal, prefix##_role_atomic_state, prefix##_role_atomic_goal, prefix##_role_intersection, prefix##_role_union, prefix##_role_complement, prefix##_role_inverse, prefix##_role_composition, prefix##_role_transitive_closure, prefix##_role_reflexive_transitive_closure, prefix##_role_restriction, prefix##_role_identity, prefix##_role_register, prefix##_role_argument) \
    BOOST_SPIRIT_DEFINE(prefix##_boolean_atomic_state, prefix##_boolean_atomic_goal, prefix##_boolean_nonempty, prefix##_boolean_eq, prefix##_boolean_neq, prefix##_boolean_lt, prefix##_boolean_le, prefix##_boolean_gt, prefix##_boolean_ge, prefix##_numerical_eq, prefix##_numerical_neq, prefix##_numerical_lt, prefix##_numerical_le, prefix##_numerical_gt, prefix##_numerical_ge, prefix##_boolean_constant, prefix##_boolean_and, prefix##_boolean_or, prefix##_boolean_not, prefix##_boolean_argument) \
    BOOST_SPIRIT_DEFINE(prefix##_numerical_count, prefix##_numerical_distance, prefix##_numerical_constant, prefix##_numerical_add, prefix##_numerical_sub, prefix##_numerical_mul, prefix##_numerical_div, prefix##_numerical_min, prefix##_numerical_max, prefix##_numerical_argument)

RUNIR_DEFINE_FAMILY_PARSER(runir::kr::BaseFamilyTag, family0)
RUNIR_DEFINE_FAMILY_PARSER(runir::kr::ExtFamilyTag, family1)
RUNIR_DEFINE_FAMILY_PARSER(runir::kr::UnsFamilyTag, family2)

#undef RUNIR_DEFINE_FAMILY_PARSER

template<>
concept_type<runir::kr::BaseFamilyTag> const& concept_parser<runir::kr::BaseFamilyTag>() { return family0_concept; }
template<>
concept_root_type<runir::kr::BaseFamilyTag> const& concept_root_parser<runir::kr::BaseFamilyTag>() { return family0_concept_root; }
template<>
role_type<runir::kr::BaseFamilyTag> const& role_parser<runir::kr::BaseFamilyTag>() { return family0_role; }
template<>
role_root_type<runir::kr::BaseFamilyTag> const& role_root_parser<runir::kr::BaseFamilyTag>() { return family0_role_root; }
template<>
boolean_type<runir::kr::BaseFamilyTag> const& boolean_parser<runir::kr::BaseFamilyTag>() { return family0_boolean; }
template<>
boolean_root_type<runir::kr::BaseFamilyTag> const& boolean_root_parser<runir::kr::BaseFamilyTag>() { return family0_boolean_root; }
template<>
numerical_type<runir::kr::BaseFamilyTag> const& numerical_parser<runir::kr::BaseFamilyTag>() { return family0_numerical; }
template<>
numerical_root_type<runir::kr::BaseFamilyTag> const& numerical_root_parser<runir::kr::BaseFamilyTag>() { return family0_numerical_root; }
template<>
grammar_root_type<runir::kr::BaseFamilyTag> const& grammar_root_parser<runir::kr::BaseFamilyTag>() { return family0_grammar_root; }

template<>
concept_type<runir::kr::ExtFamilyTag> const& concept_parser<runir::kr::ExtFamilyTag>() { return family1_concept; }
template<>
concept_root_type<runir::kr::ExtFamilyTag> const& concept_root_parser<runir::kr::ExtFamilyTag>() { return family1_concept_root; }
template<>
role_type<runir::kr::ExtFamilyTag> const& role_parser<runir::kr::ExtFamilyTag>() { return family1_role; }
template<>
role_root_type<runir::kr::ExtFamilyTag> const& role_root_parser<runir::kr::ExtFamilyTag>() { return family1_role_root; }
template<>
boolean_type<runir::kr::ExtFamilyTag> const& boolean_parser<runir::kr::ExtFamilyTag>() { return family1_boolean; }
template<>
boolean_root_type<runir::kr::ExtFamilyTag> const& boolean_root_parser<runir::kr::ExtFamilyTag>() { return family1_boolean_root; }
template<>
numerical_type<runir::kr::ExtFamilyTag> const& numerical_parser<runir::kr::ExtFamilyTag>() { return family1_numerical; }
template<>
numerical_root_type<runir::kr::ExtFamilyTag> const& numerical_root_parser<runir::kr::ExtFamilyTag>() { return family1_numerical_root; }
template<>
grammar_root_type<runir::kr::ExtFamilyTag> const& grammar_root_parser<runir::kr::ExtFamilyTag>() { return family1_grammar_root; }

template<>
concept_type<runir::kr::UnsFamilyTag> const& concept_parser<runir::kr::UnsFamilyTag>() { return family2_concept; }
template<>
concept_root_type<runir::kr::UnsFamilyTag> const& concept_root_parser<runir::kr::UnsFamilyTag>() { return family2_concept_root; }
template<>
role_type<runir::kr::UnsFamilyTag> const& role_parser<runir::kr::UnsFamilyTag>() { return family2_role; }
template<>
role_root_type<runir::kr::UnsFamilyTag> const& role_root_parser<runir::kr::UnsFamilyTag>() { return family2_role_root; }
template<>
boolean_type<runir::kr::UnsFamilyTag> const& boolean_parser<runir::kr::UnsFamilyTag>() { return family2_boolean; }
template<>
boolean_root_type<runir::kr::UnsFamilyTag> const& boolean_root_parser<runir::kr::UnsFamilyTag>() { return family2_boolean_root; }
template<>
numerical_type<runir::kr::UnsFamilyTag> const& numerical_parser<runir::kr::UnsFamilyTag>() { return family2_numerical; }
template<>
numerical_root_type<runir::kr::UnsFamilyTag> const& numerical_root_parser<runir::kr::UnsFamilyTag>() { return family2_numerical_root; }
template<>
grammar_root_type<runir::kr::UnsFamilyTag> const& grammar_root_parser<runir::kr::UnsFamilyTag>() { return family2_grammar_root; }
